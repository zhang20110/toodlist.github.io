    ...
    function load(){
        ...
        if(local !== []){
            ...
            $.each(local, function(i, con){
                ...
                li.attr('index', i);
                if(con.done) {
                    li.html('<input type="checkbox" class = "btn center" checked><input type="text" class="text" value = '+con.title+'><a class = "center" href="javascript:;"></a>');
                    $('.content ol').prepend(li);
                } else {
                    li.html('<input type="checkbox" class = "btn center"><input type="text" class="text" value = '+con.title+'><a class = "center" href="javascript:;"></a>');
